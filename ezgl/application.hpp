...
public:
  ...
  struct settings {
     ...
     */
    settings()
    : main_ui_resource("main.ui"), window_identifier("MainWindow"), canvas_identifier("MainCanvas"), setup_callbacks(nullptr)
    {
    }
...
public:
  ...
  void update_info(std::string const &message);
